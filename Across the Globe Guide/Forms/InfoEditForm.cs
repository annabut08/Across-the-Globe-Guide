...
namespace Across_the_Globe_Guide.Forms
{
    ...
    {
        readonly Models.Region region = new Models.Region();
        public event EventHandler DataSaved;

        public InfoEditForm(Models.Region region)
        {
            InitializeComponent();

            this.region = region;
            countryTextBox.Text = region.Country;
            capitalTextBox.Text = region.Capital;
            textBoxContinent.Text = region.Continent;
            textBoxPopulation.Text = region.Population.ToString();
            textBoxArea.Text = region.Area.ToString();
            currencyTextBox.Text = region.Currency;
            politicTextBox.Text = region.Politic;
            presidentTextBox.Text = region.President;
            productTextBox.Text = region.Product.ToString();
            ageTextBox.Text = region.Age.ToString();
            workTextBox.Text = region.Work.ToString();
            infoTextBox.Text = region.Info;
            languageTextBox.Text = region.Language;
            pictureBox1.ImageLocation = region.ImagePath;
        ...
        {
            region.Country = countryTextBox.Text;
            region.Capital = capitalTextBox.Text;
            region.Continent = textBoxContinent.Text;
            region.Population = int.Parse(textBoxPopulation.Text);
            region.Area = double.Parse(textBoxArea.Text);
            region.Language = languageTextBox.Text;
            region.President = presidentTextBox.Text;
            region.Product = double.Parse(productTextBox.Text);
            region.Currency = currencyTextBox.Text;
            region.Age = double.Parse(ageTextBox.Text);
            region.Work = double.Parse(workTextBox.Text);
            region.Info = infoTextBox.Text;
            region.Politic = politicTextBox.Text;
            region.ImagePath = pictureBox1.ImageLocation;
        ...
        private void politicTextBox_Validating(object sender, CancelEventArgs e)
        {
            ...
            {
                title13ErrorLabel.Visible = true;
        ...
        private void infoTextBox_Validated_1(object sender, EventArgs e)
        {
